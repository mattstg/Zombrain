...
public class Test : MonoBehaviour
{
    ...
    4) How do zombies pick thier targets to follow?
        ...
        With the function FindClosestTarget() in Zombie.cs that calls GetClosestHumanToPoint() UnitManager.cs.
        because it has includePlayer set to true it will also look for Player.
        Gets a list of Humans and Player in its detection radius and moves towards the closest Human/Player unit.
    ...
    [New Features]
    -Make A HUD that shows the amount of ammo by showing pictures of ammo in a Horizontal layout group [Done]
    -Make the HUD showcase the number of humans and zombies as text [Done]
     */
}