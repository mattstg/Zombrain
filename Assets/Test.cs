...
public class Test : MonoBehaviour
{
    ...
    4) Bullets do not seem to affect zombies, fix this.  (Do this question last)
    ...
    4) When the game starts, how is the spot for zombies and humans to spawn chosen? What safety precautions exist?
